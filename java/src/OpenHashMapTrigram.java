...
public class OpenHashMapTrigram {
    ...
    public OpenHashMapTrigram() {
        this(10);
    }

    public OpenHashMapTrigram(int initialCapacity_) {
        this(initialCapacity_, 0.7);
    }

    public OpenHashMapTrigram(int initialCapacity_, double loadFactor) {
