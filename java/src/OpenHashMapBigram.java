...
public class OpenHashMapBigram {
    ...
    public OpenHashMapBigram() {
        this(10);
    }

    public OpenHashMapBigram(int initialCapacity_) {
        this(initialCapacity_, 0.7);
    }

    public OpenHashMapBigram(int initialCapacity_, double loadFactor) {
