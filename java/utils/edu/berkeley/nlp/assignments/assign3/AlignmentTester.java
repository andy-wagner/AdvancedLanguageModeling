package edu.berkeley.nlp.assignments.assign3;
...
import edu.berkeley.nlp.assignments.assign2.student.AwesomeDecoderFactory;
import edu.berkeley.nlp.assignments.assign2.student.DistortingWithLmDecoderFactory;
import edu.berkeley.nlp.assignments.assign2.student.MonotonicNoLmDecoderFactory;
import edu.berkeley.nlp.assignments.assign2.student.MonotonicWithLmDecoderFactory;
import edu.berkeley.nlp.assignments.assign3.student.AwesomeAlignerFactory;
import edu.berkeley.nlp.assignments.assign3.student.HeuristicAlignerFactory;
import edu.berkeley.nlp.assignments.assign3.student.HmmAlignerFactory;
import edu.berkeley.nlp.assignments.assign3.student.Model1AlignerFactory;
...
public class AlignmentTester
{
	...
	enum AlignerType
	{
		...
		AWESOME
		{
			...
			@Override
			public WordAlignerFactory getWordAlignerFactory() {
				return new AwesomeAlignerFactory();
			}
		},
		BASELINE
		{
